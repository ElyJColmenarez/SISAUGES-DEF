        ...
        @foreach($data['registros'] as $persona)
                ...
                <tr class="gradeX">
                    ...
                    <td class="actions">
                        ...
                        <a href="#" class="btn btn-danger remove-row deleted-row" data-typeform="deleted" data-taction="registerform" data-field-id="{{$persona->usuario->id_usuario}}"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
