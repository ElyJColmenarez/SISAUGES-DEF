            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-3 modalscript">
                        <a class="btn btn-default click" href="#" data-typeform="add" data-taction="{{url('tutor/register-form')}}" data-field-id="0">Agregar <i class="fa fa-arrow-up" aria-hidden="true"></i></a>
                    </div>
